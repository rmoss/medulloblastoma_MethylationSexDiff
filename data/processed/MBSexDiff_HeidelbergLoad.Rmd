---
title: "Medulloblastoma Sex Differences in Methylation: Load Healthy Brain Control Data"
author: Rachel Moss
date: "6/20/2022"
output: 
  html_notebook:
...
The Heidelberg MB methylation data set is [GSE54880](https://www.ncbi.nlm.nih.gov/geo/query/acc.cgi?acc=GSE54880).
Title: Microarray-based DNA methylation profiling of medulloblastoma and normal cerebellum samples
Design: DNA methylation profiles of 276 primary medulloblastoma and 8 normal cerebellum control samples were generated from fresh-frozen and formalin-fixed paraffin-embedded material using the Illumina 450k methylation array.
This series does not have idat files but rather a file with signals A and B.
So we need to use readGEORawFile() function in minfi to read this in and convert to a GenomicMethylSet, including the appropriate pheno data. 
...
library(magrittr) # the "pipe" (%>%) we will use to facilitate sequential operations
```
