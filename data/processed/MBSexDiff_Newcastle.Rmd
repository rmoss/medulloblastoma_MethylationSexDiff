...
opts_knit$set(root.dir = "/Volumes/GoogleDrive/My Drive/Research/SexDiffMedullo/Analysis_RMM_new")
```
...
# pd = pData(gse[[1]])
# pd <- pd[,c("geo_accession","description","supplementary_file","supplementary_file.1","age (yrs):ch1","disease state:ch1","gender:ch1","pathology:ch1","sample type:ch1")]
...
# RGSet <- read.metharray.exp("GSE93646/idat", verbose=T)
# pData(RGSet) <- pd
# 
...
Load RDS object
```{r loaddata}
RGSet <- readRDS("RGSet_GSE93646.RDS")
pD.all <- pData(RGSet)
head(pD.all)
