...
GSESUPP="GSE134379_RAW.tar"
GSESUPP_URL="https://www.ncbi.nlm.nih.gov/geo/download/?acc=GSE134379&format=file"
...
# Print an indicator:
echo "Obtaining $GSESUPP"

# Curl the file (using one of several approaches)
# curl -O $GSESUPP_URL # this approach preserves the original internet file name
curl $GSESUPP_URL -o $IDAT_DEST/$GSESUPP
