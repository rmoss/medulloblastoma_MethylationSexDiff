...
Rscript --vanilla subtype_DMP_heatmaps.R -g $CavDir/GRset.flt.rds -f $CavDir/pheno_CavalliCombined_subgroupandtype_filtered.csv -p Cavalli_SHH -d $CavDir -o $outDir
